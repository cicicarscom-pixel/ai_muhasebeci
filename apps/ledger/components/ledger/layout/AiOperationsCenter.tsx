...
export default function AiOperationsCenter() {
  return (
    <aside className="fixed right-0 top-0 h-full w-[360px] bg-surface/80 backdrop-blur-3xl border-l border-white/5 shadow-[-20px_0_40px_rgba(0,0,0,0.4)] z-40 flex flex-col pt-4">
      {/* Header */}
      <div className="flex items-center gap-3 px-6 py-1 border-b border-white/5">
        <div className="w-2 h-2 rounded-full bg-primary-container/10 border border-primary-container/30 flex items-center justify-center">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3 mt-1">
          <div className="self-end bg-primary-container/10 border border-primary-container/20 rounded-2xl rounded-tr-sm px-1 py-2.5 max-w-[85%] shadow-[0_0_15px_rgba(0,229,253,0.1)]">
            <p className="text-[11px] text-on-surface leading-relaxed">Could you summarize today's anomalies?</p>
          </div>
          <div className="self-start bg-surface-container-high/50 border border-white/5 rounded-2xl rounded-tl-sm px-1 py-3 max-w-[90%]">
      ...
      {/* Input Area */}
      <div className="p-1 border-t border-white/5 bg-surface/50">
        ...
        <div className="relative">
          <input 
            ...
            className="w-full bg-surface-container-high border border-white/10 rounded-xl pl-1 pr-10 py-3 text-[11px] text-on-surface placeholder:text-on-surface-variant/40 focus:outline-none focus:border-primary-container/50 focus:ring-1 focus:ring-primary-container/50 transition-all shadow-inner"
          />

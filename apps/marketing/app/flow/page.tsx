    ...
    <div className="min-h-screen bg-ai-dark text-white font-body-md overflow-x-hidden selection:bg-ai-purple selection:text-white">
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-24 pb-20 flex flex-col lg:flex-row items-center gap-12 min-h-[85vh]">
        ...
        <div className="flex-1 flex flex-col items-start z-20">
          ...
          <h1 className="text-[48px] md:text-[56px] lg:text-[64px] leading-[1.05] font-extrabold tracking-tight mb-6">
            İşletmenizi<br />
            Yöneten Tek<br />
        ...
        <div className="flex-[1.2] relative w-full h-[600px] hidden lg:flex items-center justify-center z-10">
          <div className="relative w-full max-w-[850px] aspect-[4/3] flex items-center justify-center scale-[0.8] xl:scale-100 origin-center">
          
          {/* Background Ambient Glow */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
            <div className="w-[300px] h-[300px] bg-gradient-to-r from-blue-600/30 to-purple-600/30 blur-[80px] rounded-full mix-blend-screen"></div>
          </div>
          ...
          <div className="absolute inset-0 w-full h-full pointer-events-none z-10 flex items-center justify-center">
            <svg className="w-full h-full absolute inset-0" viewBox="0 0 850 600" preserveAspectRatio="xMidYMid meet">
               ...
               {/* Left side lines (From X=230 to X=350, Center Y=300) */}
               <path d="M 230,120 C 300,120 300,280 360,280" fill="none" stroke="url(#neon-blue-pink)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 230,170 C 280,170 300,290 360,290" fill="none" stroke="url(#neon-blue-pink)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 230,220 C 270,220 310,295 360,295" fill="none" stroke="url(#neon-blue-pink)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 230,270 C 280,270 320,300 360,300" fill="none" stroke="url(#neon-blue-pink)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 230,320 C 280,320 320,305 360,305" fill="none" stroke="url(#neon-blue-pink)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 230,370 C 270,370 310,310 360,310" fill="none" stroke="url(#neon-blue-pink)" strokeWidth="1.5" filter="url(#glow-strong)" />
               
               {/* Right side lines (From X=490 to X=610, Center Y=300) */}
               <path d="M 490,270 C 540,270 540,120 610,120" fill="none" stroke="url(#neon-pink-blue)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 490,290 C 530,290 550,220 610,220" fill="none" stroke="url(#neon-pink-blue)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 490,310 C 530,310 550,330 610,330" fill="none" stroke="url(#neon-pink-blue)" strokeWidth="1.5" filter="url(#glow-strong)" />
               <path d="M 490,330 C 540,330 540,430 610,430" fill="none" stroke="url(#neon-pink-blue)" strokeWidth="1.5" filter="url(#glow-strong)" />
            </svg>
          </div>

          {/* Left Box: TÜM KANALLAR TEK YERDE */}
          <div className="absolute left-[30px] top-[90px] w-[200px] bg-[#0A0D14]/90 backdrop-blur-xl border border-white/5 rounded-[16px] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)] z-20">
            <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4 pl-1">TÜM KANALLAR TEK YERDE</div>
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-[24px] h-[24px] rounded-[6px] bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] flex items-center justify-center"><span className="material-symbols-outlined text-white text-[14px]">photo_camera</span></div>
                  <span className="text-[12px] font-medium text-gray-100">Instagram</span>
                </div>
                <div className="bg-[#E11D48] text-white text-[10px] px-2 py-0.5 rounded-full font-bold">23</div>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-[24px] h-[24px] rounded-[6px] bg-[#25D366] flex items-center justify-center"><span className="material-symbols-outlined text-white text-[14px]">chat</span></div>
                  <span className="text-[12px] font-medium text-gray-100">WhatsApp</span>
                </div>
                <div className="bg-[#1E3A8A] text-white text-[10px] px-2 py-0.5 rounded-full font-bold">15</div>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-[24px] h-[24px] rounded-[6px] bg-[#1877F2] flex items-center justify-center"><span className="material-symbols-outlined text-white text-[14px]">thumb_up</span></div>
                  <span className="text-[12px] font-medium text-gray-100">Facebook</span>
                </div>
                <div className="bg-[#1E3A8A] text-white text-[10px] px-2 py-0.5 rounded-full font-bold">12</div>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-[24px] h-[24px] rounded-[6px] bg-[#F5B400] flex items-center justify-center"><span className="material-symbols-outlined text-white text-[14px]">star</span></div>
                  <span className="text-[12px] font-medium text-gray-100">Google Yorumlar</span>
                </div>
                <div className="bg-[#1E3A8A] text-white text-[10px] px-2 py-0.5 rounded-full font-bold">8</div>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-[24px] h-[24px] rounded-[6px] bg-gradient-to-tr from-[#00B2FF] to-[#006AFF] flex items-center justify-center"><span className="material-symbols-outlined text-white text-[14px]">forum</span></div>
                  <span className="text-[12px] font-medium text-gray-100">Messenger</span>
                </div>
                <div className="bg-[#1E3A8A] text-white text-[10px] px-2 py-0.5 rounded-full font-bold">7</div>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-[24px] h-[24px] rounded-[6px] bg-[#0A66C2] flex items-center justify-center"><span className="material-symbols-outlined text-white text-[14px]">work</span></div>
                  <span className="text-[12px] font-medium text-gray-100">LinkedIn</span>
                </div>
          ...
          {/* Central AI Sphere */}
          <div className="absolute z-30 flex flex-col items-center justify-center left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            
            {/* Top Chat Bubble */}
            <div className="absolute top-[-90px] left-[-70px] bg-[#0A0D14]/90 border border-white/5 rounded-2xl rounded-br-sm p-3 w-[160px] shadow-2xl flex flex-col gap-1 z-40 backdrop-blur-md">
              <div className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">AI ASİSTAN</div>
              <div className="text-[11px] text-gray-200">Merhaba! Size nasıl yardımcı olabilirim?</div>
              <div className="absolute right-[-25px] top-[15px] w-6 h-6 rounded-full bg-[#0A0D14] border border-white/10 flex items-center justify-center shadow-lg">
                <span className="material-symbols-outlined text-[12px] text-[#00F0FF] animate-pulse">graphic_eq</span>
              </div>
            </div>

            {/* Glowing 3D Wireframe Globe */}
            <div className="w-[160px] h-[160px] rounded-full relative flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#FF00AA]/50 via-[#8A2BE2]/50 to-[#00F0FF]/50 blur-[25px] rounded-full"></div>
              <div className="absolute w-full h-full rounded-full border border-blue-400/40 shadow-[inset_0_0_30px_rgba(0,100,255,0.6)]"></div>
              ...
              <div className="w-[100px] h-[100px] bg-[#05070A] rounded-full shadow-[0_0_30px_rgba(138,43,226,0.7)] flex items-center justify-center z-10 border border-purple-500/30 relative overflow-hidden">
                ...
                <span className="text-[40px] font-black text-white drop-shadow-[0_0_10px_rgba(255,255,255,1)] z-10 tracking-tight">AI</span>
              </div>
            </div>

            {/* Bottom Status Pill */}
            <div className="absolute bottom-[-40px] bg-[#0A0D14]/90 border border-white/5 rounded-full px-4 py-2 shadow-xl flex items-center gap-2 z-40 backdrop-blur-md">
              <div className="w-2 h-2 rounded-full bg-[#10B981] shadow-[0_0_8px_#10B981] animate-pulse"></div>
              <span className="text-[10px] font-bold text-gray-300 tracking-widest">7/24 OTONOM ÇALIŞIYOR</span>
            </div>
          </div>

          {/* Right Boxes Container */}
          <div className="absolute right-[10px] top-[80px] flex flex-col gap-3 z-20">
            
            {/* Box 1: İÇERİK ÜRETİYOR */}
            <div className="w-[240px] bg-[#0A0D14]/90 backdrop-blur-xl border border-white/5 rounded-[14px] p-3 shadow-2xl relative">
              <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">İÇERİK ÜRETİYOR</div>
              <div className="flex gap-3 items-center">
                 ...
                 <div className="flex flex-col">
                   <div className="text-[11px] leading-tight text-gray-200 font-medium mb-1.5">Yeni koleksiyon paylaşımı hazır! ✨</div>
                   <div className="flex gap-1.5">
                     <div className="w-[14px] h-[14px] rounded bg-gradient-to-tr from-[#f09433] to-[#bc1888] flex items-center justify-center"><span className="material-symbols-outlined text-[8px] text-white">photo_camera</span></div>
                     <div className="w-[14px] h-[14px] rounded bg-[#1877F2] flex items-center justify-center"><span className="material-symbols-outlined text-[8px] text-white">thumb_up</span></div>
                     <div className="w-[14px] h-[14px] rounded bg-[#0A66C2] flex items-center justify-center"><span className="material-symbols-outlined text-[8px] text-white">work</span></div>
                     <div className="w-[14px] h-[14px] rounded bg-[#EA4335] flex items-center justify-center"><span className="material-symbols-outlined text-[8px] text-white">g_translate</span></div>
                   </div>
                 </div>
              </div>
            </div>
            ...
            <div className="w-[240px] bg-[#0A0D14]/90 backdrop-blur-xl border border-white/5 rounded-[14px] p-3 shadow-2xl relative">
              <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">MÜŞTERİLERE YANIT VERİYOR</div>
              <div className="bg-[#141A27] rounded-lg p-2 border border-white/5 flex items-center gap-2">
                 ...
                 <div className="text-[11px] leading-[1.3] text-gray-300">Siparişiniz yola çıktı!<br/>Teşekkürler. 🧡</div>
              </div>
            </div>

            {/* Box 3: MUHASEBEYE İŞLENİYOR */}
            <div className="w-[240px] bg-[#0A0D14]/90 backdrop-blur-xl border border-white/5 rounded-[14px] p-3 shadow-2xl relative">
              <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">MUHASEBEYE İŞLENİYOR</div>
              <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-lg bg-[#0F172A] flex items-center justify-center flex-shrink-0 border border-blue-500/30">
                   <span className="material-symbols-outlined text-[18px] text-[#00F0FF]">description</span>
                 </div>
                 <div className="flex flex-col flex-1">
                   <div className="text-[11px] font-bold text-gray-200">Fatura okundu</div>
                   <div className="text-[10px] text-gray-400">KDV: %20</div>
                   <div className="text-[11px] text-gray-200 mt-0.5">Tutar: <span className="font-bold">₺2.450</span></div>
                 </div>
              </div>
            </div>
            ...
            <div className="w-[240px] bg-[#0A0D14]/90 backdrop-blur-xl border border-white/5 rounded-[14px] p-3 shadow-2xl relative">
              <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">MUHASEBECİNİZLE PAYLAŞIYOR</div>
              <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-full bg-[url('https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center border border-white/20"></div>
                 <div className="flex flex-col">
                   <div className="text-[11px] font-bold text-gray-200 mb-0.5">Yeni belge geldi</div>
      ...
      <section className="relative z-20 w-full max-w-7xl mx-auto px-6 py-16 flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="flex-1 flex flex-col items-start w-full">
           ...
           <h2 className="text-[32px] md:text-[40px] font-extrabold leading-[1.1] mb-6">
             Tüm Kanallar<br/>
             Tek Gelen Kutusunda
           </h2>
      ...
      <section className="relative z-20 w-full max-w-7xl mx-auto px-6 py-20 flex flex-col items-center">
        ...
        <h2 className="text-[28px] md:text-[36px] font-extrabold mb-10 text-center">
          İşletmenizi Büyüten AI Gücü
        </h2>

        {/* Horizontal scrollable / grid container */}
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 pb-8">
          
          {/* Card 1: AI İçerik */}
          <div className="w-full h-[320px] bg-[#121418] border border-[#2A2E35] rounded-2xl p-5 flex flex-col snap-center hover:border-pink-500/50 transition-colors group">
          ...
          {/* Card 2: AI Muhasebe */}
          <div className="w-full h-[320px] bg-[#121418] border border-[#2A2E35] rounded-2xl p-5 flex flex-col snap-center hover:border-cyan-500/50 transition-colors group">
          ...
          {/* Card 3: AI Asistan */}
          <div className="w-full h-[320px] bg-[#121418] border border-[#2A2E35] rounded-2xl p-5 flex flex-col snap-center hover:border-purple-500/50 transition-colors group">
          ...
          {/* Card 4: AI Analitik */}
          <div className="w-full h-[320px] bg-[#121418] border border-[#2A2E35] rounded-2xl p-5 flex flex-col snap-center hover:border-blue-500/50 transition-colors group">
          ...
          {/* Card 5: AI Otomasyon */}
          <div className="w-full h-[320px] bg-[#121418] border border-[#2A2E35] rounded-2xl p-5 flex flex-col snap-center hover:border-green-500/50 transition-colors group">

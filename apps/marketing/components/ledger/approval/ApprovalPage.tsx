                    ...
                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-3 overflow-x-auto custom-scrollbar">
                      <div className="min-w-[420px]">
                        ...
                        <div className="grid grid-cols-5 gap-2 mb-2">
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%1 KDV</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%8 KDV</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%10 KDV</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%18 KDV</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%20 KDV</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-[#00daf3] px-2 text-right border-[#00daf3]/30" defaultValue="200.00" /></div>
                        </div>
                        {/* Matrah Fields */}
                        <div className="grid grid-cols-5 gap-2">
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%1 Matrah</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%8 Matrah</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%10 Matrah</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%18 Matrah</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-white px-2 text-right" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[12px] font-medium text-[#bac9cc] uppercase">%20 Matrah</label><input className="w-full h-8 bg-white/[0.04] border border-white/5 rounded-md text-[14px] text-[#00daf3] px-2 text-right border-[#00daf3]/30" defaultValue="1,000.00" /></div>
                        </div>
                      </div>
                    </div>
                  </div>

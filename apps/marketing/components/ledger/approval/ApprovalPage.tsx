      ...
      <main className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-[320px] flex-shrink-0 bg-surface flex flex-col border-r border-border z-10 h-full">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-2">
            {/* Active Item */}
            <div className="p-4 rounded-card border border-primary/50 bg-primary/5 shadow-glow-primary cursor-pointer flex flex-col gap-2 transition-all">
              <div className="flex items-center gap-1">
                <div className="w-[24px] h-[24px] rounded-[4px] bg-white flex items-center justify-center p-1">
            ...
            {/* Migros */}
            <div className="p-4 rounded-card border border-border hover:bg-card/50 cursor-pointer transition-colors flex flex-col gap-2">
              <div className="flex items-center gap-1">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <section className="w-1/2 h-full bg-card relative flex items-center justify-center p-8 overflow-hidden group">
            ...
            <div className="w-full max-w-[600px] aspect-[1/1.414] bg-white rounded-card shadow-2xl relative overflow-hidden transition-transform duration-medium ease-out flex flex-col p-8 group-hover:shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-border">
              ...
              <div className="flex justify-between items-start mb-12">
                ...
                <div className="text-right">
                  <div className="w-[192px] h-[24px] bg-gray-200 rounded opacity-50 mb-4"></div>
                  <div className="w-[128px] h-[16px] bg-gray-200 rounded opacity-50 mb-2 ml-auto"></div>
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        ...
                        <input className="w-full h-9 bg-white border border-border rounded-lg text-[13px] text-[#0E1117] px-3 focus:outline-none focus:border-primary transition-all" type="date" defaultValue="2025-05-25" />
                      </div>
                      <div className="space-y-1">
                        <label className="text-[10px] font-medium text-text-muted tracking-wider uppercase">Fatura Numarası</label>
                        <input className="w-full h-9 bg-white border border-border rounded-lg text-[#0E1117] px-3 focus:outline-none focus:border-primary transition-all font-mono text-[13px]" type="text" defaultValue="SHE202500123" />
                      </div>
                      <div className="space-y-1">
                      ...
                      <div className="space-y-1">
                        ...
                        <input className="w-full h-9 bg-white border border-border rounded-lg text-[#0E1117] px-3 focus:outline-none focus:border-primary transition-all font-mono text-[13px]" type="text" defaultValue="1234567890" />
                      </div>
                      <div className="col-span-2 space-y-1">
                        <label className="text-[10px] font-medium text-text-muted tracking-wider uppercase">Açıklama</label>
                        <input className="w-full h-9 bg-white border border-border rounded-lg text-[13px] text-[#0E1117] px-3 focus:outline-none focus:border-primary transition-all" type="text" defaultValue="Akaryakıt Alımı" />
                      </div>
                    </div>
                  </div>

                    ...
                    <div className="bg-card border border-border rounded-card p-12 overflow-x-auto custom-scrollbar">
                      <div className="min-w-[420px]">
                        ...
                        <div className="grid grid-cols-5 gap-16 mb-12">
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%1 KDV</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%8 KDV</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%10 KDV</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%18 KDV</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-primary uppercase px-4">%20 KDV</label><input className="w-full h-[32px] bg-primary/10 border-b border-primary/50 focus:border-primary outline-none text-body font-mono font-bold text-primary px-4 text-right transition-colors rounded-none" defaultValue="200.00" /></div>
                        </div>
                        {/* Matrah Fields */}
                        <div className="grid grid-cols-5 gap-16">
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%1 Matrah</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%8 Matrah</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%10 Matrah</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-text-muted uppercase px-4">%18 Matrah</label><input className="w-full h-[32px] bg-transparent border-b border-white/10 hover:border-border focus:border-primary outline-none text-body font-mono font-bold text-text px-4 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-4"><label className="text-label font-bold text-primary uppercase px-4">%20 Matrah</label><input className="w-full h-[32px] bg-primary/10 border-b border-primary/50 focus:border-primary outline-none text-body font-mono font-bold text-primary px-4 text-right transition-colors rounded-none" defaultValue="1,000.00" /></div>
                        </div>
                      </div>
                    </div>
                  </div>

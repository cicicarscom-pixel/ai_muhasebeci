                    ...
                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-3 overflow-x-auto custom-scrollbar">
                      <div className="min-w-[420px]">
                        ...
                        <div className="grid grid-cols-5 gap-4 mb-3">
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%1 KDV</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%8 KDV</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%10 KDV</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%18 KDV</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#00C8FF] uppercase px-1">%20 KDV</label><input className="w-full h-8 bg-[#00C8FF]/[0.03] border-b border-[#00C8FF]/50 focus:border-[#00C8FF] outline-none text-[14px] text-[#00C8FF] px-1 text-right transition-colors rounded-none" defaultValue="200.00" /></div>
                        </div>
                        {/* Matrah Fields */}
                        <div className="grid grid-cols-5 gap-4">
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%1 Matrah</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%8 Matrah</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%10 Matrah</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#bac9cc] uppercase px-1">%18 Matrah</label><input className="w-full h-8 bg-transparent border-b border-white/10 hover:border-white/30 focus:border-[#00C8FF] outline-none text-[14px] text-white px-1 text-right transition-colors rounded-none" defaultValue="0.00" /></div>
                          <div className="space-y-1"><label className="text-[11px] font-medium text-[#00C8FF] uppercase px-1">%20 Matrah</label><input className="w-full h-8 bg-[#00C8FF]/[0.03] border-b border-[#00C8FF]/50 focus:border-[#00C8FF] outline-none text-[14px] text-[#00C8FF] px-1 text-right transition-colors rounded-none" defaultValue="1,000.00" /></div>
                        </div>
                      </div>
                    </div>
                  </div>

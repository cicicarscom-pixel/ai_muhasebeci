    ...
    <div className="flex flex-col h-full w-full bg-[#0E1117] text-white p-6 overflow-hidden">
      ...
      <div className="flex-1 flex gap-4 overflow-x-auto pb-4 custom-scrollbar">
        ...
        <div className="flex flex-col min-w-[300px] w-[300px] bg-[#12151C] border border-white/5 rounded-2xl border-t-[3px] border-t-[#00daf3] p-4 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-[#00daf3] text-[18px]">desktop_windows</span>
              <h2 className="text-[14px] font-semibold text-white">Muhasebeleşti</h2>
            </div>
            <span className="bg-[#00daf3]/10 text-[#00daf3] text-[12px] font-bold px-2 py-0.5 rounded-full">37</span>
          </div>
          <p className="text-[11px] text-[#8B949E] mb-4">Sisteme aktarıldı</p>
          
          <div className="flex flex-col gap-3 overflow-y-auto custom-scrollbar flex-1 pr-1">
            
            {/* Card 1 */}
            <div className="bg-[#161B22] border border-white/5 rounded-xl p-3.5 hover:border-white/10 transition-colors cursor-pointer opacity-80">
              <div className="flex justify-between items-center mb-3">
                <span className="text-[11px] text-[#9D5CFF] font-medium">ABC Yazılım Ltd.</span>
                <span className="material-symbols-outlined text-[#8B949E] text-[14px]">description</span>
              </div>
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[16px]">account_balance</span>
                <span className="text-[13px] font-medium text-white">Garanti BBVA</span>
              </div>
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[14px]">calendar_today</span>
                <span className="text-[12px] text-[#8B949E]">24.05.2025</span>
              </div>
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[16px]">payments</span>
                <span className="text-[14px] font-bold text-white">₺28.750,00</span>
              </div>
              <div className="flex items-center gap-1.5 mb-3">
                <span className="text-[12px] font-medium text-[#00daf3]">102</span>
                <span className="text-[11px] text-[#8B949E]">Banka Gideri</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5 text-[11px] text-[#8B949E]">
                ...
                <div className="flex items-center gap-1 text-[11px] text-[#3FB950] font-medium">
                  <span className="material-symbols-outlined text-[14px]">check</span> Aktarıldı
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#161B22] border border-white/5 rounded-xl p-3.5 hover:border-white/10 transition-colors cursor-pointer opacity-80">
              ...
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[16px]">health_and_safety</span>
                <span className="text-[13px] font-medium text-white">SGK</span>
              </div>
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[14px]">calendar_today</span>
                <span className="text-[12px] text-[#8B949E]">24.05.2025</span>
              ...
              <div className="flex items-center gap-1.5 mb-3">
                <span className="text-[12px] font-medium text-[#00daf3]">360</span>
                <span className="text-[11px] text-[#8B949E]">SGK Gideri</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5 text-[11px] text-[#8B949E]">
                  <span className="material-symbols-outlined text-[14px]">public</span> Portal
            ...
            <div className="bg-[#161B22] border border-white/5 rounded-xl p-3.5 hover:border-white/10 transition-colors cursor-pointer opacity-80">
              ...
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[16px]">account_balance_wallet</span>
                <span className="text-[13px] font-medium text-white">Kuveyt Türk</span>
              </div>
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[14px]">calendar_today</span>
                <span className="text-[12px] text-[#8B949E]">24.05.2025</span>
              ...
              <div className="flex items-center gap-2 mb-1.5">
                <span className="material-symbols-outlined text-[#8B949E] text-[16px]">payments</span>
                <span className="text-[14px] font-bold text-white">₺9.350,00</span>
              </div>
              <div className="flex items-center gap-1.5 mb-3">
                <span className="text-[12px] font-medium text-[#00daf3]">102</span>
                <span className="text-[11px] text-[#8B949E]">Banka Gideri</span>

...
export default function WorkflowPage() {
  return (
    <div className="flex flex-col h-full w-full bg-surface text-text p-6 overflow-hidden gap-6">
      ...
      {/* 32px spacing is managed by flex gap-8 below */}
      <div className="flex-1 flex gap-1 overflow-x-auto pb-4 custom-scrollbar pt-2">
        ...
        <div className="flex flex-col min-w-[280px] w-[280px] bg-card/30 border border-border rounded-card border-l-[3px] border-l-[#7B61FF] p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-text text-muted font-bold px-2 py-1 rounded-badge bg-surface border border-border">18</span>
          </div>
          ...
          <div className="flex flex-col gap-1 overflow-y-auto custom-scrollbar flex-1 pr-1">
            ...
            <AppCard className="p-4 cursor-pointer">
              ...
              <div className="flex items-center gap-1 text-muted text-text-muted">
            ...
            <AppCard className="p-4 cursor-pointer">
              ...
              <div className="flex items-center gap-1 text-muted text-success">
                <span className="material-symbols-outlined text-[14px]">chat</span> WhatsApp
              </div>
            </AppCard>

            <GhostButton className="w-full mt-1 flex items-center justify-center gap-2 border border-border bg-surface">
        ...
        <div className="flex flex-col min-w-[280px] w-[280px] bg-card/30 border border-border rounded-card border-l-[3px] border-l-primary p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-text text-muted font-bold px-2 py-1 rounded-badge bg-surface border border-border">6</span>
          </div>
        ...
        <div className="flex flex-col min-w-[280px] w-[280px] bg-card/30 border border-border rounded-card border-l-[3px] border-l-warning p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-text text-muted font-bold px-2 py-1 rounded-badge bg-surface border border-border">19</span>
          </div>
          ...
          <div className="flex flex-col gap-1 overflow-y-auto custom-scrollbar flex-1 pr-1">
            <AppCard className="p-4 cursor-pointer">
              <div className="flex justify-between items-center mb-4">
                <span className="text-muted text-[#58A6FF] font-semibold">ABC Yazılım Ltd.</span>
                <div className="flex items-center gap-2">
                  <div className="bg-warning/10 text-warning text-muted font-bold px-2 py-1 rounded-badge flex items-center gap-1 border border-warning/20">
        ...
        <div className="flex flex-col min-w-[280px] w-[280px] bg-card/30 border border-border rounded-card border-l-[3px] border-l-success p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-text text-muted font-bold px-2 py-1 rounded-badge bg-surface border border-border">31</span>
          </div>
